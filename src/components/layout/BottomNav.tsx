...
export function BottomNav() {
  ...
  async function handlePost() {
    ...
    setPosting(true);
    try {
      await createPost.mutateAsync({ content: content.trim(), files: [], visibility });
      setContent("");
      setShowModal(false);
    } finally {
      setPosting(false);
    ...
    <>
      ...
      <nav className="fixed bottom-0 left-0 right-0 z-50
        ...
        <div className="flex items-center justify-around h-16 px-2 max-w-lg mx-auto">
          ...
          <NavTab href="/messages" icon={MessageCircle} label="মেসেজ"    active={pathname === "/messages"} />
      ...
      {showModal && (
        ...
        >
          <div className="w-full max-w-lg bg-white dark:bg-gray-900
                          rounded-t-3xl px-4 pt-3 pb-10
                          border-t border-gray-100 dark:border-gray-800 shadow-xl">

            {/* Handle */}
            <div className="w-10 h-1 bg-gray-200 dark:bg-gray-700 rounded-full mx-auto mb-4" />

            <div className="flex items-center justify-between mb-4">
              <h2 className="text-base font-semibold text-gray-900 dark:text-white">পোস্ট করুন</h2>
              <button
              ...
              <div>
                ...
                <select
                  ...
                  className="text-xs text-gray-500 bg-gray-100 dark:bg-gray-800
                             rounded-lg px-1.5 py-0.5 mt-1 border-none outline-none cursor-pointer"
                >
            ...
            <textarea
              ...
              placeholder="কী ভাবছেন?"
              rows={5}
              className="w-full resize-none bg-transparent text-gray-800 dark:text-gray-100
                         text-[15px] leading-relaxed placeholder:text-gray-400 outline-none mb-4"
            />
